                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Data Belum Masuk</span>
                    ...
                    <section class="col-lg-7 connectedSortable ui-sortable">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Rekap Data Pegawai</h5>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <p class="text-center"><strong>ㅤㅤㅤㅤㅤㅤ</strong></p>
                                        <div class="chart">
                                            <canvas id="salesChart" height="180" style="height: 180px;"></canvas>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="text-center"><strong>Data Keseluruhan</strong></p>
                                        <div class="progress-group">
                                            Jumlah Pegawai
                                            <span class="float-right"><b>{{ $jumlahpegawai }}</b>/50</span>
                                        ...
                                        <div class="progress-group">
                                            Pegawai Pria
                                            <span class="float-right"><b>{{ $jumlahpegawaiPria }}</b>/50</span>
                                            <div class="progress progress-sm">
                                        ...
                                        <div class="progress-group">
                                            Pegawai Wanita
                                            <span class="float-right"><b>{{ $jumlahpegawaiWanita }}</b>/50</span>
                                            <div class="progress progress-sm">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td data-action="selectDay" data-day="01/13/2024"
                                                                        class="day active today weekend">13</td>
                                                                </tr>
                                                                <tr>
